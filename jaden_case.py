...
below. Your task is to convert strings to how they would be written by Jaden Smith. The strings are 
...
def to_jaden_case_best(string):
    return " ".join(w.capitalize() for w in string.split())

print(to_jaden_case_best(string))