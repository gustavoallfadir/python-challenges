...
the power of the number of digits in a given base. In this Kata, we will restrict ourselves to 
decimal (base 10).
...
def narcissistic( value ):
    return value == sum(pow(int(n),len(str(value))) for n in str(value))
